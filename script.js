...
(function() {
  ...
  function initCursor() {
    ...
    var hoverEls = document.querySelectorAll('a, button, .product-card, .why-card, .step-item, .contact-card, .gallery-item, .value-chain-card, .timeline-card, input, textarea, select');
  ...
  function initHeroAnimations() {
    ...
    if (heroTitle && typeof SplitType !== 'undefined') {
      ...
      // Products cutout entrance - scale in from right
